...
int menu(void)
{
	...
	cout << "6. Считывание данных из файла " << endl;
...
int returnN(Address** phead, Address** plast)
{
	if (*phead == *plast && *phead == NULL)
	{
		...
		cout << "Список содержит информацию ";
		return 1;
	}
